...
const Nav: FC = () => {
  return (
    <>
      <nav
        className={
          'flex justify-between items-center max-w-5xl w-full p-8 my-0 md:my-8 mx-auto '
        }
      >
  ...
  return (
    <li>
      <Link href={route === 'home' ? '/' : `/${route}`}>
        <a
          className={`cursor-pointer px-1 md:px-2 text-md md:text-lg lg:text-xl font-medium text-gray-900 capitalize border-b-4 border-transparent hover:text-gray-500 transition ${
